...
import com.et.be.base.handlers.AliPayMessageHandler;
import com.et.be.base.interceptor.AliPayMessageInterceptor;
...
//                .template(jdbcTemplate);
     ...
     /*   HttpConfigStorage wxHttpConfigStorage = new HttpConfigStorage();
        ...
        merchants.inMemory()
                ...
                .inputCharset("utf-8")
                .notifyUrl("http://106.13.194.32:8081/pay/payBack1.json")
                .returnUrl("http://106.13.194.32:8081/pay/payBack1.json")
